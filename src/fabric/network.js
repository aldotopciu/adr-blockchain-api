...
exports.connectToNetwork = async function (userName) {
  ...
  try {
    ...
    const contract = await network.getContract('AccountBasedContract');// still to verify
...
exports.registerUser = async function (userId, balance) {
  ...
  try {
    ...
    console.log("Sucesfully registered user");    
